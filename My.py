...
def thread_run(number, proxy):
    try:
        req_number = '{}-{}-{}'.format(number[0:3], number[3:6], number[6:10])
...
if __name__ == '__main__':
    ...
    source_file = '/home/ubuntu/laptop/My.txt'
    thread_number_list = source_txt(path=source_file)
    fileName = 'My.csv'
    pass_file = 'pass_phones_My.csv'
    failed_file = 'failed_phones_My.csv'
    Not_Found = 'Not_Found_My.csv'
